...
1. Создать Deployment приложения [_frontend_](frontend.yaml) из образа nginx с количеством реплик 3 шт.
2. Создать Deployment приложения [_backend_](backend.yaml) из образа multitool. 
