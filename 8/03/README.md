...
1. Допишите [playbook](./playbook/site.yml): нужно сделать ещё один play, который устанавливает и настраивает LightHouse.
2. При создании tasks рекомендую использовать модули: `get_url`, `template`, `yum`, `apt`.
3. Tasks должны: скачать статику LightHouse, установить Nginx или любой другой веб-сервер, настроить его конфиг для открытия LightHouse, запустить веб-сервер.
4. Подготовьте свой inventory-файл [`prod.yml`](./playbook/inventory/prod.yml).
...
--- before
+++ after: /home/mask/.ansible/tmp/ansible-local-85407sw3sgb28/tmpzs76no4l/vector.service.j2
@@ -0,0 +1,22 @@
+[Unit]
+Description=Vector
...
+++ after: /home/mask/.ansible/tmp/ansible-local-85407sw3sgb28/tmpzjf_epwu/vector.toml.j2
@@ -11,7 +11,7 @@
...
--- before
+++ after: /home/mask/.ansible/tmp/ansible-local-85407sw3sgb28/tmpf8p1cyh6/nginx.repo.j2
@@ -0,0 +1,7 @@
+[nginx-stable]
...
TASK [Install nginx and packages] ***********************************************************************************
changed: [lighthouse-01]
...
+++ after: /home/mask/.ansible/tmp/ansible-local-85407sw3sgb28/tmpv555_0z9/nginx.conf.j2
@@ -1,44 +1,12 @@
 server {
     listen       80;
...
[tag](https://github.com/maslovkv/devops-netology/releases/tag/08-ansible-03-yandex)
